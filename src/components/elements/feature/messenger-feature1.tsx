...
const MessengerFeature1 = ({ feature }: Props) => {
        ...
        {items && items.length && (
          <div className="mt-[20px] md:mt-[40px] lg:mt-[70px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[10px] lg:gap-[30px] mx-[20px] xl:mx-[70px] justify-center">
            {items.map((item, i) => (
              ...
              >
                <div className="group rounded-theme bg-white p-[15px] md:p-[50px] flex flex-col items-center text-center transition duration-300 ease-in-out hover:bg-[#f5f6fa]">
                  {item.icon && (
...
export default MessengerFeature1;
